const BookingSection: React.FC<{ price: number }> = ({ price }) => {
  return (
    <div className="hidden sm:block bg-white p-6 shadow-md shadow-zinc-700 rounded-lg w-[250px] lg:w-80 h-[410px] md:h-[430px] shrink-0">
      ...
      <div className="mt-4">
        <label htmlFor="check-in-book" className="text-xs text-zinc-950">Check-in</label>
        <input
          id="check-in-book"
          type="date"
      ...
      <div className="mt-4">
        <label htmlFor="check-out-book" className="text-xs text-zinc-950">Check-out</label>
        <input
          id="check-out-book"
          type="date"
      ...
      <div className="mt-4 pb-4 border-b-[1px] border-neutral-300">
        <p className="flex items-center justify-between text-sm">
          ...
          <span className="text-zinc-950 font-medium"><strong>$350</strong></span>
        </p>
        <p className="flex items-center justify-between text-sm">
          <span className="text-zinc-600">Weekly discounts</span>
          <span className=" text-zinc-950 font-medium"><strong>-$88</strong></span>
        </p>
        <p className="flex items-center justify-between text-sm">
          <span className="text-zinc-600">Service fee</span>
          <span className="text-zinc-950 font-medium"><strong>$33</strong></span>
        </p>
      </div>
