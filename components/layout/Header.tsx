    ...
    <header>
      <section className='bg-teal-600 px-2 pb-1 pt-5 sm:pt-1'>
        <div className='flex items-center justify-center gap-3'>
          ...
          />
          <p className='text-white text-[11px] sm:text-xs font-semibold'>Overseas trip? Get the latest information on travel guides</p>
          <button
            ...
            <form className='flex items-center'>
              ...
              <div className='hidden sm:grid grid-cols-5 w-full sm:max-w-md lg:max-w-2xl'>
                <div className='col-span-2 sm:flex flex-col pr-2 border-r-[1px] border-neutral-300'>
                  <label htmlFor='location' className='text-zinc-900 font-medium text-xs'>Location</label>
                  <input
                    type="search"
                    name="location"
                    id="location"
                ...
                <div className='flex flex-col px-2 border-r-[1px] border-neutral-300'>
                  <label htmlFor='check-in' className='text-zinc-900 font-medium text-xs'>Check in</label>
                  <input
                    type="date"
                    name="check-in"
                    id="check-in"
                ...
                <div className='flex flex-col px-2 border-r-[1px] border-neutral-300'>
                  <label htmlFor='check-out' className='text-zinc-900 font-medium text-xs'>Check out</label>
                  <input
                    type="date"
                    name="check-out"
                    id="check-out"
                ...
                <div className='flex flex-col pl-2'>
                  <label htmlFor='people' className='text-zinc-900 font-medium text-xs'>People</label>
                  <input
                    type="search"
                    name="people"
                    id="people"
